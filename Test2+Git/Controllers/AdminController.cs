...
using static Test2_Git.Controllers.ManageController;
using static Test2_Git.Models.AdminUserViewModels;
...
namespace Test2_Git.Controllers
{
    public class AdminController : Controller
    {
        ...
        public static List<AdminUserViewModels> usrList = new List<AdminUserViewModels>();
        ...
        public IEnumerable<SelectListItem> GetUserRoles(string usrrole)
        {
            ...
            rList.Add(new AdminRoleViewModel() { Role = "Klient", RoleId = "2" });
